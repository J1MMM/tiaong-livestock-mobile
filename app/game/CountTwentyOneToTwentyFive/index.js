...
const bgImage = require('../../../assets/images/bg21-25.jpg');


const image1 = require('../../../assets/images/fly.png')
const image2 = require('../../../assets/images/owl.png')
const image3 = require('../../../assets/images/frog.png')
const image4 = require('../../../assets/images/pad.png')
const image5 = require('../../../assets/images/gator.png')
...
const CountTwentyOneToTwentyFive = () => {
    ...
    useEffect(() => {
        if (!isLoading) {
            const random = generateRandomSortedArray(21, 25)
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#9accef' }}>
            ...
            <ImageBackground source={bgImage} style={styles.bgImage} resizeMode='cover'>
                ...
                <Text style={{ fontSize: 28, fontFamily: 'bold', color: '#FFF', letterSpacing: 2, marginTop: 10 }}>Count the objects</Text>
...
export default CountTwentyOneToTwentyFive;
