...
const bgImage = require('../../../assets/images/forest.jpg');

const sound1 = require('../../../assets/audio/raccoon.mp3')
const sound2 = require('../../../assets/audio/balloon.mp3')
const sound3 = require('../../../assets/audio/success.mp3')
...
const FillTheBlank4 = () => {
    ...
    const Obj1 = { word: ['R', 'A', 'C', 'C', 'O', 'O', 'N'], sound: sound1, img: require('../../../assets/images/raccoon.png') }
    const Obj2 = { word: ['B', 'A', 'L', 'L', 'O', 'O', 'N'], sound: sound2, img: require('../../../assets/images/balloon.png') }
    const Obj3 = { word: ['S', 'U', 'C', 'C', 'E', 'S', 'S'], sound: sound3, img: require('../../../assets/images/success.png') }
