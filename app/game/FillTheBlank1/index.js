...
const bgImage = require('../../../assets/images/river.jpg');

const duck = require('../../../assets/audio/duck.mp3')
const five = require('../../../assets/audio/five.mp3')
const gift = require('../../../assets/audio/gift.mp3')
...
const FillTheBlank1 = () => {
    ...
    const duckObj = { word: ['D', 'U', 'C', 'K'], sound: duck, img: require('../../../assets/images/duck.png') }
    const fiveObj = { word: ['F', 'I', 'V', 'E'], sound: five, img: require('../../../assets/images/five.png') }
    const giftObj = { word: ['G', 'I', 'F', 'T'], sound: gift, img: require('../../../assets/images/gift.png') }

    const allChoices = [duckObj, fiveObj, giftObj]
    ...
    useEffect(() => {
        ...
        setCorrectAns(ans)
        setCurrentChoices(mixLetters(ans, generateChoices.word.length))
    }, [level])
