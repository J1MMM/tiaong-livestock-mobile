...
const bgImage = require('../../../assets/images/bg16-20.jpg');


const image1 = require('../../../assets/images/plate.png')
const image2 = require('../../../assets/images/row.png')
const image3 = require('../../../assets/images/ox.png')
const image4 = require('../../../assets/images/mon.png')
const image5 = require('../../../assets/images/goat.png')
...
const CountSixteenToTwenty = () => {
    ...
    useEffect(() => {
        if (!isLoading) {
            const random = generateRandomSortedArray(16, 20)
...
export default CountSixteenToTwenty;
