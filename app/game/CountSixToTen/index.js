...
const bgImage = require('../../../assets/images/bg6-10.jpg');

const image1 = require('../../../assets/images/candy.png')
const image2 = require('../../../assets/images/ball.png')
const image3 = require('../../../assets/images/umbrella.png')
const image4 = require('../../../assets/images/cloud.png')
const image5 = require('../../../assets/images/shoe.png')
...
const CountingObjects = () => {
    ...
    useEffect(() => {
        if (!isLoading) {
            const random = generateRandomSortedArray(6, 10)
