...
const bgImage = require('../../../assets/images/bikinibottom.jpg');

const sound1 = require('../../../assets/audio/brain.mp3')
const sound2 = require('../../../assets/audio/knife.mp3')
const sound3 = require('../../../assets/audio/snail.mp3')
...
const FillTheBlank2 = () => {
    ...
    const Obj1 = { word: ['S', 'N', 'A', 'I', 'L'], sound: sound3, img: require('../../../assets/images/snail.png') }
    const Obj2 = { word: ['K', 'N', 'I', 'F', 'E'], sound: sound2, img: require('../../../assets/images/knife.png') }
    const Obj3 = { word: ['B', 'R', 'A', 'I', 'N'], sound: sound1, img: require('../../../assets/images/brain.png') }
